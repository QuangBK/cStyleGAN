...
#         )
        self.from_rgb_ = nn.ModuleList(
            [
                EqualConv2d(3+n_class_age, 16, 1),
                EqualConv2d(3+n_class_age, 32, 1),
                EqualConv2d(3+n_class_age, 64, 1),
                EqualConv2d(3+n_class_age, 128, 1),
                EqualConv2d(3+n_class_age, 128, 1),
                EqualConv2d(3+n_class_age, 256, 1),
...
#                 EqualConv2d(3+n_class_age, 512, 1),
        ...
        self.conv1_2 = nn.Conv2d(n_class_age, 32, 4, 2, 1)
    ...
    def forward(self, input, label_age=None, step=0, alpha=-1):
        
        img_size = input.shape[2]
        label_age = label_age.view(-1,n_class_age,1,1)
        label_age = label_age.repeat(1,1,img_size,img_size)
...
#                 out = self.from_rgb[index](input)
                input_ = torch.cat([input, label_age], 1)
